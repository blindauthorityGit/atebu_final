        ...
        >
            ...
            <div className="right px-8 sm:px-0 col-span-12 lg:col-span-7 flex flex-col justify-center ">
                ...
                <Link href={props.link}>
                    <button className="bg-primaryColor hover-underline-animation z-20 flex items-center justify-center text-primaryColor-200 mt-4 lg:mt-8 py-2 text-sm sm:text-base sm:py-3 px-6 min-w-[10rem] w-full uppercase rounded-md md:mt-16">
